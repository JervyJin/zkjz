<template>
  <div class="page">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>人员参与率</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <div class="tableWrap">
      ...
      >
        ...
        <el-table-column prop="joinnum" label="参与任务人数"></el-table-column>
        <el-table-column prop="count" label="总人数"></el-table-column>
        <el-table-column prop="ratio" label="参与率"></el-table-column>
      </el-table>
    </div>
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      loading: false,
      tableData: [
        // { name: '中原区', taskCount: 500, userCount: 30, ratio: '20'},
        // { name: '中原区', taskCount: 500, userCount: 30, ratio: '20'},
        // { name: '中原区', taskCount: 500, userCount: 30, ratio: '20'},
        // { name: '中原区', taskCount: 500, userCount: 30, ratio: '20'},
        // { name: '中原区', taskCount: 500, userCount: 30, ratio: '20'},
    ...
    getData() {
      ...
      this.$ajax(url.userJoinRatio, {
        ...
        if(res.success) {
          let data = res.data;
          data.forEach(v => {
            v.ratio = `${v.count == 0 ? 0 : parseInt((v.joinnum / v.count) * 1000) / 10}%`
          })
          this.tableData = data;
        }
      })
